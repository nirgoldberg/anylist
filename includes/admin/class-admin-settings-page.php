...
if ( ! class_exists( 'anylist_admin_settings_page' ) ) :

class anylist_admin_settings_page {
	 ...
	 * admin_menu
	 *
	 * This function will add Any List submenu item to the WP admin
	 *
	 * @since		1.0.0
	 * @param		N/A
	 * @return		N/A
	...
	function html() {
		...
		// load view
		anylist_get_view( 'settings', $view );
